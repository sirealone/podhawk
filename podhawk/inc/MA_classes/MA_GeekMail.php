<?php
  ...
  */
  ...
  class MA_GeekMail
  {
    protected $_altBoundary   = '';
    protected $_altMessage    = '';
    protected $_atcBoundary   = '';
    protected $_attachDisp    = array();
    protected $_attachName    = array();
    protected $_attachType    = array();
    protected $_baseCharsets  = array('us-ascii', 'iso-2022-');
    protected $_bccArray      = array();
    protected $_bccBatchMode  = false;
    protected $_bccBatchSize  = 200;
    protected $_bitDepths     = array('7bit', '8bit');
    protected $_body          = '';
    protected $_ccArray       = array();
    protected $_charSet       = 'utf-8';
    protected $_crlf          = "\n";
    protected $_debugMsg      = array();
    protected $_encoding      = '8bit';
    protected $_finalBody     = '';
    protected $_headerStr     = '';
    protected $_headers       = array();
    protected $_ip            = false;
    protected $_log           = array();
    protected $_mailPath      = MAIL_PATH;
    protected $_mailType      = 'text';
    protected $_multipart     = 'mixed';
    protected $_newLine       = "\n";
    protected $_priorities    = array('1 (Highest)', '2 (High)', '3 (Normal)', '4 (Low)', '5 (Lowest)');
    protected $_priority      = '3';
    protected $_protocol      = 'mail';
    protected $_protocols     = array('mail', 'sendmail', 'smtp');
    protected $_recipients    = array();
    protected $_replytoFlag   = false;
    protected $_safeMode      = false;
    protected $_sendMultipart = true;
    protected $_smtpAuth      = false;
    protected $_smtpConnect   = '';
    protected $_smtpHost      = '';
    protected $_smtpPass      = '';
    protected $_smtpPort      = '25';
    protected $_smtpTimeout   = 5;
    protected $_smtpUser      = '';
    protected $_systemEmail   = 'noreply@getsmarter.co.za';
    protected $_subject       = '';
    protected $_userAgent     = 'Getsmarter';
    protected $_validate      = false;
    protected $_wordWrap      = true;
    protected $_wrapChars     = '76';
    ...
    */
    public function attach($filename, $disposition = 'attachment'/*'inline'*/)
    {
      ...
      $this->_attachType[] = $this->_mimeTypes(next($bits));
    ...
    */
	...
	protected function getSenderDomain ($url)  
	{

	// first we see if the sender is specified in phpini
	...
	// else if the site host name contains only one . then it must also be the domain name
	else
	{
		...
		// otherwise we make the heroic assumption that we have a single subdomain eg www in front of the domain name
		else
		{
			$pos = strpos ($b, '.');
			return substr($b, $pos+1);
		}
	}
  }
}
